      ...
      >
        ...
        <View className="items-center mt-8">
          ...
          <View className="flex-row items-start mt-4">
            <Text className="text-8xl font-light text-blue-900">28</Text>
            <Text className="text-4xl font-light text-blue-900 mt-2">°C</Text>
          </View>
          <Text className="text-xl font-medium text-blue-600 mt-2">Sunny</Text>
        </View>
        ...
        <View className="mt-8 mx-4">
          ...
          >
            {[
              { day: "Mon", temp: "29°/22°", condition: "sunny" },
              { day: "Tue", temp: "28°/21°", condition: "cloudy" },
              { day: "Wed", temp: "27°/20°", condition: "rainy" },
              { day: "Thu", temp: "29°/22°", condition: "sunny" },
              { day: "Fri", temp: "28°/21°", condition: "partlyCloudy" },
              { day: "Sat", temp: "27°/20°", condition: "sunny" },
              { day: "Sun", temp: "26°/19°", condition: "cloudy" },
            ].map((day, index) => (
